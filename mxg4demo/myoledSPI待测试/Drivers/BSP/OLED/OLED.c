...
void OLED_W_D0(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOA, SCK_Pin, (GPIO_PinState)BitValue);
...
void OLED_W_D1(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOA, MOSI_Pin, (GPIO_PinState)BitValue);
...
void OLED_W_RES(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOA, RES_Pin, (GPIO_PinState)BitValue);
...
void OLED_W_DC(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOA, DC_Pin, (GPIO_PinState)BitValue);
...
void OLED_W_CS(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOA, CS_Pin, (GPIO_PinState)BitValue);
