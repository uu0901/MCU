 ...
 */
// Single-step rainbow updater.
// This function advances the internal rainbow state by one step and returns.
// Caller is responsible for timing (vTaskDelay) if continuous updates are desired.
