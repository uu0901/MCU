...
void MyCAN_Init(void)
{
	...
	*/
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh = 0x234 << 5;//0x234
	CAN_FilterInitStructure.CAN_FilterIdLow = 0x345 << 5;//0x345
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh = 0x567 << 5;//0x567
