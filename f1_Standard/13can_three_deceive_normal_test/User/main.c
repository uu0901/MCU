...
int main(void)
{
	...
	*/	
	...
	while (1)
	{
		...
		oledShowString(0, 0, "TxID:", OLED_8X16);
		oledShowHexNum(40, 0, TxID, 3, OLED_8X16);
		...
		if (MyCAN_ReceiveFlag())
		{
			...
			oledShowHexNum(40, 16, RxID, 3, OLED_8X16);
			oledShowHexNum(40, 32, RxLength, 1, OLED_8X16);
			oledShowHexNum(40, 48, RxData[0], 2, OLED_8X16);
			oledShowHexNum(64, 48, RxData[1], 2, OLED_8X16);
			oledShowHexNum(88, 48, RxData[2], 2, OLED_8X16);
			oledShowHexNum(112, 48, RxData[3], 2, OLED_8X16);
		}
	}
}
