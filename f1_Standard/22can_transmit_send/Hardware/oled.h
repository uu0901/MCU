...
#define OLED_SCL_CLK_ENABLE()               do{RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);}while(0)

#define OLED_SDA_GPIO_PORT                  GPIOB
#define OLED_SDA_GPIO_PIN                   GPIO_Pin_9
#define OLED_SDA_CLK_ENABLE()               do{RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);}while(0)
/*参数宏定义*********************/
