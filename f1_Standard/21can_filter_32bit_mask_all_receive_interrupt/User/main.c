	...
	while (1)
	{
		...
		if (MyCAN_RxFlag == 1)
		{
			...
			if (MyCAN_RxMsg.IDE == CAN_Id_Standard)
			{
				...
				oledShowHexNum(40, 16, MyCAN_RxMsg.StdId, 8, OLED_8X16);
			}
			else if (MyCAN_RxMsg.IDE == CAN_Id_Extended)
			{
				oledShowString(40, 0, "Ext", OLED_8X16);
				
				oledShowHexNum(40, 16, MyCAN_RxMsg.ExtId, 8, OLED_8X16);
			}
			...
			if (MyCAN_RxMsg.RTR == CAN_RTR_Data)
			{
				...
				oledShowHexNum(40, 32, MyCAN_RxMsg.DLC, 1, OLED_8X16);
				
				oledShowHexNum(40, 48, MyCAN_RxMsg.Data[0], 2, OLED_8X16);
				oledShowHexNum(64, 48, MyCAN_RxMsg.Data[1], 2, OLED_8X16);
				oledShowHexNum(88, 48, MyCAN_RxMsg.Data[2], 2, OLED_8X16);
				oledShowHexNum(112, 48, MyCAN_RxMsg.Data[3], 2, OLED_8X16);
			}
