...
#define AUTO_FLASH_MAC_ADDRESS                             (0x62000000)
#undef  DFU_FLASH_CODE_START_ADDR
#define DFU_FLASH_CODE_START_ADDR                          (0x624A0000)
#undef  DFU_FLASH_CODE_SIZE
#define DFU_FLASH_CODE_SIZE                                (0x00080000)
#undef  DFU_FLASH_CODE_OFFSET
#define DFU_FLASH_CODE_OFFSET                              (0x004A0000)
#undef  DFU_INFO_REGION_START_ADDR
#define DFU_INFO_REGION_START_ADDR                         (0x62520000)
#undef  DFU_INFO_REGION_SIZE
#define DFU_INFO_REGION_SIZE                               (0x00020000)
#undef  DFU_INFO_REGION_OFFSET
#define DFU_INFO_REGION_OFFSET                             (0x00520000)
#undef  DFU_DOWNLOAD_REGION_START_ADDR
#define DFU_DOWNLOAD_REGION_START_ADDR                     (0x62780000)
#undef  DFU_DOWNLOAD_REGION_SIZE
#define DFU_DOWNLOAD_REGION_SIZE                           (0x00120000)
#undef  DFU_DOWNLOAD_REGION_OFFSET
#define DFU_DOWNLOAD_REGION_OFFSET                         (0x00780000)
#undef  FS_REGION_START_ADDR
#define FS_REGION_START_ADDR                               (0x628A0000)
#undef  FS_REGION_SIZE
#define FS_REGION_SIZE                                     (0x00400000)
#undef  FS_REGION_OFFSET
#define FS_REGION_OFFSET                                   (0x008A0000)
#undef  KVDB_DFU_REGION_START_ADDR
#define KVDB_DFU_REGION_START_ADDR                         (0x62CA0000)
#undef  KVDB_DFU_REGION_SIZE
#define KVDB_DFU_REGION_SIZE                               (0x00004000)
#undef  KVDB_DFU_REGION_OFFSET
#define KVDB_DFU_REGION_OFFSET                             (0x00CA0000)
#undef  KVDB_BLE_REGION_START_ADDR
#define KVDB_BLE_REGION_START_ADDR                         (0x62CA4000)
#undef  KVDB_BLE_REGION_SIZE
#define KVDB_BLE_REGION_SIZE                               (0x00004000)
#undef  KVDB_BLE_REGION_OFFSET
#define KVDB_BLE_REGION_OFFSET                             (0x00CA4000)
...
#undef  DFU_PSRAM_CODE_START_ADDR
#define DFU_PSRAM_CODE_START_ADDR                          (0x10000000)
#undef  DFU_PSRAM_CODE_SIZE
#define DFU_PSRAM_CODE_SIZE                                (0x00080000)
#undef  DFU_PSRAM_CODE_OFFSET
#define DFU_PSRAM_CODE_OFFSET                              (0x00000000)
