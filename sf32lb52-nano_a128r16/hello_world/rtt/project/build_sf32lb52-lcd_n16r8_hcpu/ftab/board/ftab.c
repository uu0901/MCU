...
RT_USED const struct sec_configuration sec_config =
{
    ...
    .ftab[3] = {.base = 0x12010000, .size = 0x00020000,  .xip_base = 0x20020000, .flags = 0},
    ...
    .ftab[7] = {.base = 0x12010000, .size = 0x00020000,  .xip_base = 0x20020000, .flags = 0},
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU)] = {.length = 0x0004C5EC, .blksize = 512, .flags = DFU_FLAG_AUTO},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_LCPU)] = {.length = 0xFFFFFFFF},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_BL)] = {.length = 0x0000E16C, .blksize = 512, .flags = DFU_FLAG_AUTO},
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU2)] = {.length = 0x0004C5EC, .blksize = 512, .flags = DFU_FLAG_AUTO},
